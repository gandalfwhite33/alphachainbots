#!/usr/bin/env python3
"""
AlphaChainBots — Hyperliquid Trading Bot (1H · EMA 21/55)
Entrada : EMA 21/55 crossover + S/R + Fibonacci 0.5/0.618 + Volume Profile
...
class Bot:
    ...
    def run(self) -> None:
        log.info("=" * 60)
        log.info(f" AlphaChainBots 1H·EMA21/55 — {'TESTNET' if TESTNET else 'MAINNET'}")
