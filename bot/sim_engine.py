...
CONFIGS = [
    ...
    # ── GRUPO 1: BTC LONG (idx 36-39) — top_params_btc_v2, direction=long ────────
    BotConfig(idx=36,
        name="bot_15m_btc_l",   label="BOT\xb715M\xb7BTC\xb7L",
        interval="15m",          ma_type="sma",  ma_fast=100, ma_slow=200,
        trailing_pct=0.015,      min_vol_ratio=1.0, sr_near_pct=0.008,
        fibo_zone_pct=0.011,     candle_limit=300,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="fixed",         time_filter="none",
        coins=["BTC"],           direction="long",  risk_per_trade=0.05,
    ),
    BotConfig(idx=37,
        name="bot_30m_btc_l",   label="BOT\xb730M\xb7BTC\xb7L",
        interval="30m",          ma_type="sma",  ma_fast=100, ma_slow=200,
        trailing_pct=0.02,       min_vol_ratio=1.0, sr_near_pct=0.008,
        fibo_zone_pct=0.011,     candle_limit=250,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="fixed",         time_filter="asia",
        coins=["BTC"],           direction="long",  risk_per_trade=0.05,
    ),
    BotConfig(idx=38,
        name="bot_2h_btc_l",    label="BOT\xb72H\xb7BTC\xb7L",
        interval="2h",           ma_type="ema",  ma_fast=20,  ma_slow=50,
        trailing_pct=0.02,       min_vol_ratio=1.0, sr_near_pct=0.010,
        fibo_zone_pct=0.012,     candle_limit=250,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="fixed",         time_filter="none",
        coins=["BTC"],           direction="long",  risk_per_trade=0.05,
    ...
    BotConfig(idx=39,
        name="bot_4h_btc_l",    label="BOT\xb74H\xb7BTC\xb7L",
        interval="4h",           ma_type="sma",  ma_fast=50,  ma_slow=100,
        trailing_pct=0.01,       min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,     candle_limit=300,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="atr",           time_filter="none",
        coins=["BTC"],           direction="long",  risk_per_trade=0.05,
    ),
    # ── GRUPO 2: BTC SHORT (idx 40-43) — top_params_btc_short, direction=short ──
    BotConfig(idx=40,
        name="bot_15m_btc_s",   label="BOT\xb715M\xb7BTC\xb7S",
        interval="15m",          ma_type="ema",  ma_fast=8,   ma_slow=21,
        trailing_pct=0.005,      min_vol_ratio=1.0, sr_near_pct=0.008,
        fibo_zone_pct=0.011,     candle_limit=300,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="fixed",         time_filter="none",
        coins=["BTC"],           direction="short", risk_per_trade=0.05,
    ),
    BotConfig(idx=41,
        name="bot_30m_btc_s",   label="BOT\xb730M\xb7BTC\xb7S",
        interval="30m",          ma_type="sma",  ma_fast=50,  ma_slow=100,
        trailing_pct=0.01,       min_vol_ratio=1.0, sr_near_pct=0.008,
        fibo_zone_pct=0.011,     candle_limit=250,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="atr",           time_filter="none",
        coins=["BTC"],           direction="short", risk_per_trade=0.05,
    ...
    BotConfig(idx=42,
        name="bot_1h_btc_s",    label="BOT\xb71H\xb7BTC\xb7S",
        interval="1h",           ma_type="sma",  ma_fast=50,  ma_slow=100,
        trailing_pct=0.02,       min_vol_ratio=1.0, sr_near_pct=0.010,
        fibo_zone_pct=0.012,     candle_limit=200,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="trailing",      time_filter="london_ny",
        coins=["BTC"],           direction="short", risk_per_trade=0.03,
    ),
    BotConfig(idx=43,
        name="bot_4h_btc_s",    label="BOT\xb74H\xb7BTC\xb7S",
        interval="4h",           ma_type="sma",  ma_fast=50,  ma_slow=100,
        trailing_pct=0.03,       min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,     candle_limit=300,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="fixed",         time_filter="none",
        coins=["BTC"],           direction="short", risk_per_trade=0.05,
    ),
    # ── GRUPO 3: BTC LONG+SHORT (idx 44-45) — top_params_btc_v2, direction=both ─
    BotConfig(idx=44,
        name="bot_1h_btc_ls",   label="BOT\xb71H\xb7BTC\xb7LS",
        interval="1h",           ma_type="sma",  ma_fast=100, ma_slow=200,
        trailing_pct=0.008,      min_vol_ratio=1.0, sr_near_pct=0.010,
        fibo_zone_pct=0.012,     candle_limit=200,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="fixed",         time_filter="asia",
        coins=["BTC"],           direction="both",  risk_per_trade=0.05,
    ),
    BotConfig(idx=45,
        name="bot_4h_btc_ls",   label="BOT\xb74H\xb7BTC\xb7LS",
        interval="4h",           ma_type="sma",  ma_fast=50,  ma_slow=100,
        trailing_pct=0.01,       min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,     candle_limit=300,  leverage=15.0,
        require_fib=False,       require_sr=False,
    ...
    # ── GRUPO 4: ETH LONG (idx 46-49) — top_params_eth_v2, direction=long ────────
    BotConfig(idx=46,
        name="bot_15m_eth_l",   label="BOT\xb715M\xb7ETH\xb7L",
        interval="15m",          ma_type="sma",  ma_fast=50,  ma_slow=100,
        trailing_pct=0.01,       min_vol_ratio=1.0, sr_near_pct=0.008,
        fibo_zone_pct=0.011,     candle_limit=300,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="fixed",         time_filter="asia",
        coins=["ETH"],           direction="long",  risk_per_trade=0.05,
    ),
    BotConfig(idx=47,
        name="bot_30m_eth_l",   label="BOT\xb730M\xb7ETH\xb7L",
        interval="30m",          ma_type="ema",  ma_fast=20,  ma_slow=50,
        trailing_pct=0.03,       min_vol_ratio=1.0, sr_near_pct=0.008,
        fibo_zone_pct=0.011,     candle_limit=250,  leverage=10.0,
        require_fib=False,       require_sr=False,
    ...
    BotConfig(idx=48,
        name="bot_2h_eth_l",    label="BOT\xb72H\xb7ETH\xb7L",
        interval="2h",           ma_type="sma",  ma_fast=100, ma_slow=200,
        trailing_pct=0.015,      min_vol_ratio=1.0, sr_near_pct=0.010,
        fibo_zone_pct=0.012,     candle_limit=250,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="trailing",      time_filter="none",
        coins=["ETH"],           direction="long",  risk_per_trade=0.05,
    ),
    BotConfig(idx=49,
        name="bot_4h_eth_l",    label="BOT\xb74H\xb7ETH\xb7L",
        interval="4h",           ma_type="sma",  ma_fast=100, ma_slow=200,
        trailing_pct=0.03,       min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,     candle_limit=300,  leverage=15.0,
        require_fib=False,       require_sr=False,
    ...
    # ── GRUPO 5: ETH SHORT (idx 50-52) — top_params_eth_short, direction=short ───
    BotConfig(idx=50,
        name="bot_15m_eth_s",   label="BOT\xb715M\xb7ETH\xb7S",
        interval="15m",          ma_type="sma",  ma_fast=50,  ma_slow=100,
        trailing_pct=0.008,      min_vol_ratio=1.0, sr_near_pct=0.008,
        fibo_zone_pct=0.011,     candle_limit=300,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="trailing",      time_filter="none",
        coins=["ETH"],           direction="short", risk_per_trade=0.05,
    ),
    BotConfig(idx=51,
        name="bot_1h_eth_s",    label="BOT\xb71H\xb7ETH\xb7S",
        interval="1h",           ma_type="sma",  ma_fast=100, ma_slow=200,
        trailing_pct=0.03,       min_vol_ratio=1.0, sr_near_pct=0.010,
        fibo_zone_pct=0.012,     candle_limit=200,  leverage=15.0,
        require_fib=False,       require_sr=False,
    ...
    BotConfig(idx=52,
        name="bot_4h_eth_s",    label="BOT\xb74H\xb7ETH\xb7S",
        interval="4h",           ma_type="sma",  ma_fast=50,  ma_slow=100,
        trailing_pct=0.003,      min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,     candle_limit=300,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="atr",           time_filter="none",
        coins=["ETH"],           direction="short", risk_per_trade=0.05,
    ),
    # ── GRUPO 6: ETH LONG+SHORT (idx 53-56) — top_params_eth_v2, direction=both ──
    BotConfig(idx=53,
        name="bot_1h_eth_ls",   label="BOT\xb71H\xb7ETH\xb7LS",
        interval="1h",           ma_type="ema",  ma_fast=21,  ma_slow=55,
        trailing_pct=0.03,       min_vol_ratio=1.0, sr_near_pct=0.010,
        fibo_zone_pct=0.012,     candle_limit=200,  leverage=15.0,
        require_fib=False,       require_sr=False,
        sl_type="trailing",      time_filter="asia",
        coins=["ETH"],           direction="both",  risk_per_trade=0.05,
    ),
    BotConfig(idx=54,
        name="bot_2h_eth_ls",   label="BOT\xb72H\xb7ETH\xb7LS",
        interval="2h",           ma_type="sma",  ma_fast=100, ma_slow=200,
        trailing_pct=0.015,      min_vol_ratio=1.0, sr_near_pct=0.010,
        fibo_zone_pct=0.012,     candle_limit=250,  leverage=15.0,
        require_fib=False,       require_sr=False,
    ...
    BotConfig(idx=55,
        name="bot_30m_eth_ls",  label="BOT\xb730M\xb7ETH\xb7LS",
        interval="30m",          ma_type="ema",  ma_fast=20,  ma_slow=50,
        trailing_pct=0.03,       min_vol_ratio=1.0, sr_near_pct=0.008,
        fibo_zone_pct=0.011,     candle_limit=250,  leverage=10.0,
        require_fib=False,       require_sr=False,
    ...
    BotConfig(idx=56,
        name="bot_4h_eth_ls",   label="BOT\xb74H\xb7ETH\xb7LS",
        interval="4h",           ma_type="sma",  ma_fast=100, ma_slow=200,
        trailing_pct=0.03,       min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,     candle_limit=300,  leverage=15.0,
        require_fib=False,       require_sr=False,
...
class SimBot:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "errors":       self.errors,
            "coins":        self.coins,
            "direction":    getattr(self.cfg, "direction", "both"),
