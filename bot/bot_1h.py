#!/usr/bin/env python3
"""
AlphaChainBots — Hyperliquid Trading Bot (1H)
...
Diferencias vs bot.py: INTERVAL=1h | TRAILING_PCT=1% | ciclo cada 1h
"""
...
TRAILING_PCT    = 0.010     # 1.0% trailing stop (bot 1H — más ajustado)
MIN_VOL_RATIO   = 1.5
FIBO_ZONE_PCT   = 0.012     # ±1.2% zona fib (más estrecha en 1H)
SR_LOOKBACK     = 60
SR_WINDOW       = 4         # Ventana de pivots más corta para 1H
