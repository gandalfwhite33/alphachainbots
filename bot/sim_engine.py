...
CONFIGS = [
    # ── SHORT (mercado bajista) ────────────────────────────────────────────────
    BotConfig(idx=0,
        name="bot_cons_short",  label="BOT·CONSERVADOR",
        ...
        direction="short",      coins=[],           risk_per_trade=0.05,
    ),
    BotConfig(idx=1,
        name="bot_eq_short",    label="BOT·EQUILIBRADO",
        interval="2h",          ma_type="ema",  ma_fast=8,   ma_slow=21,
        trailing_pct=0.010,     min_vol_ratio=1.0, sr_near_pct=0.010,
    ...
    BotConfig(idx=2,
        name="bot_agr_short",   label="BOT·AGRESIVO",
    ...
    BotConfig(idx=3,
        name="bot_4h_eth_s",    label="BOT·4H·ETH·S",
        interval="4h",          ma_type="ema",  ma_fast=8,   ma_slow=21,
        trailing_pct=0.010,     min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,    candle_limit=300,  leverage=15.0,
        require_fib=False,      require_sr=False,
        sl_type="atr",          time_filter="london_ny",
        direction="short",      coins=[],           risk_per_trade=0.05,
    ),
    BotConfig(idx=4,
        name="bot_4h_btc_s",    label="BOT·4H·BTC·S",
        interval="4h",          ma_type="ema",  ma_fast=8,   ma_slow=21,
        trailing_pct=0.010,     min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,    candle_limit=300,  leverage=15.0,
        require_fib=False,      require_sr=False,
    ...
    BotConfig(idx=5,
        name="bot_30m_eth_s",   label="BOT·30M·ETH·S",
        interval="30m",         ma_type="ema",  ma_fast=20,  ma_slow=50,
        trailing_pct=0.010,     min_vol_ratio=1.0, sr_near_pct=0.008,
        fibo_zone_pct=0.011,    candle_limit=250,  leverage=15.0,
        require_fib=False,      require_sr=False,
        sl_type="fixed",        time_filter="asia",
        direction="short",      coins=[],           risk_per_trade=0.05,
    ),
    # ── LONG (mercado alcista) ─────────────────────────────────────────────────
    BotConfig(idx=6,
        name="bot_1h_btc_l",    label="BOT·1H·BTC·L",
        ...
        direction="long",       coins=[],           risk_per_trade=0.05,
    ),
    BotConfig(idx=7,
        name="bot_2h_btc_l",    label="BOT·2H·BTC·L",
    ...
    BotConfig(idx=8,
        name="bot_4h_eth_l",    label="BOT·4H·ETH·L",
        interval="4h",          ma_type="sma",  ma_fast=100, ma_slow=200,
        trailing_pct=0.015,     min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,    candle_limit=300,  leverage=15.0,
        require_fib=False,      require_sr=False,
    ...
    BotConfig(idx=9,
        name="bot_1h_eth_l",    label="BOT·1H·ETH·L",
        interval="1h",          ma_type="ema",  ma_fast=13,  ma_slow=34,
        trailing_pct=0.010,     min_vol_ratio=1.0, sr_near_pct=0.010,
        fibo_zone_pct=0.012,    candle_limit=200,  leverage=15.0,
        require_fib=False,      require_sr=False,
    ...
    # ── LONG+SHORT (ambos mercados) ────────────────────────────────────────────
    BotConfig(idx=10,
        name="bot_4h_eth_ls",   label="BOT·4H·ETH·LS",
        interval="4h",          ma_type="sma",  ma_fast=100, ma_slow=200,
        trailing_pct=0.015,     min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,    candle_limit=300,  leverage=15.0,
        require_fib=False,      require_sr=False,
        sl_type="atr",          time_filter="none",
        direction="both",       coins=[],           risk_per_trade=0.05,
    ),
    BotConfig(idx=11,
        name="bot_2h_sol_ls",   label="BOT·2H·SOL·LS",
        interval="2h",          ma_type="sma",  ma_fast=50,  ma_slow=100,
    ...
    BotConfig(idx=12,
        name="bot_30m_eth_ls",  label="BOT·30M·ETH·LS",
        interval="30m",         ma_type="ema",  ma_fast=20,  ma_slow=50,
        trailing_pct=0.010,     min_vol_ratio=1.0, sr_near_pct=0.008,
        fibo_zone_pct=0.011,    candle_limit=250,  leverage=15.0,
        require_fib=False,      require_sr=False,
    ...
    BotConfig(idx=13,
        name="bot_4h_sol_ls",   label="BOT·4H·SOL·LS",
        interval="4h",          ma_type="ema",  ma_fast=13,  ma_slow=34,
        trailing_pct=0.02,      min_vol_ratio=1.0, sr_near_pct=0.012,
        fibo_zone_pct=0.015,    candle_limit=300,  leverage=15.0,
        require_fib=False,      require_sr=False,
    ...
    BotConfig(idx=14,
        name="bot_1h_btc_ls",   label="BOT·1H·BTC·LS",
    ...
    # ── HIGH FREQUENCY (muchos trades) ────────────────────────────────────────
    BotConfig(idx=15,
        name="bot_15m_hf",      label="BOT·15M·HF",
        interval="15m",         ma_type="ema",  ma_fast=8,   ma_slow=21,
        trailing_pct=0.005,     min_vol_ratio=1.0, sr_near_pct=0.007,
    ...
    BotConfig(idx=17,
        name="bot_1h_multi",    label="BOT·1H·MULTI",
        interval="1h",          ma_type="sma",  ma_fast=50,  ma_slow=100,
        trailing_pct=0.010,     min_vol_ratio=1.0, sr_near_pct=0.010,
        fibo_zone_pct=0.012,    candle_limit=200,  leverage=15.0,
        require_fib=False,      require_sr=False,
