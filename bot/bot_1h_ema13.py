#!/usr/bin/env python3
"""
AlphaChainBots — Hyperliquid Trading Bot (1H · EMA 13/34)
Entrada : EMA 13/34 crossover + S/R + Fibonacci 0.5/0.618 + Volume Profile
...
class Bot:
    ...
    def run(self) -> None:
        log.info("=" * 60)
        log.info(f" AlphaChainBots 1H·EMA13/34 — {'TESTNET' if TESTNET else 'MAINNET'}")
