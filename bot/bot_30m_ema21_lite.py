#!/usr/bin/env python3
"""
AlphaChainBots — Hyperliquid Trading Bot (30M · EMA 21/55 · LITE)
Entrada : EMA 21/55 crossover + Volume 1.1x (sin Fibonacci ni S/R obligatorio)
...
class Bot:
    ...
    def run(self) -> None:
        log.info("=" * 60)
        log.info(f" AlphaChainBots 30M·EMA21/55·LITE — {'TESTNET' if TESTNET else 'MAINNET'}")
