#!/usr/bin/env python3
"""
AlphaChainBots — Hyperliquid Trading Bot (30M · EMA 8/21 · LITE)
Entrada : EMA 8/21 crossover + Volume 1.1x (sin Fibonacci ni S/R obligatorio)
...
class Bot:
    ...
    def run(self) -> None:
        log.info("=" * 60)
        log.info(f" AlphaChainBots 30M·EMA8/21·LITE — {'TESTNET' if TESTNET else 'MAINNET'}")
